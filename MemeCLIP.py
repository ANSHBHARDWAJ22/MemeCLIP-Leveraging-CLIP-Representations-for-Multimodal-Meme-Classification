...
class MemeCLIP(pl.LightningModule):
    ...
    def __init__(self, cfg): #Is constructor mein poora model ka dimaag, dil, aur skeleton daal diya gaya hai.
# Bas data do, aur training chalu!
        super().__init__()
        self.cfg = cfg
        self.cfg = cfg # added abhi
 ...
 # image and ext ke tokens nikale clip seand then usma linear projection lagaya ha 
    ...
    def init_head_text_feat(self):
        # Ham classifier ke weights ko text prompts se initialize kar rahe hain, 
        # kyunki CLIP ne image aur text ko ek hi jagah project karna seekha hai — 
        # toh image ka best match wahi class prompt hoga jiska embedding uske closest ho.
